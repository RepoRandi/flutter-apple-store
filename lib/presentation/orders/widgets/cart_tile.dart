import 'package:apple_store/core/components/spaces.dart';
...
class CartTile extends StatelessWidget {
  ...
  final int index;
  const CartTile({super.key, required this.data, required this.index});
          ...
          children: [
            SlidableAction(
              onPressed: (context) {
                context
                    .read<CheckoutBloc>()
                    .add(CheckoutEvent.removeCartAtIndex(index));
              },
                  ...
                  ClipRRect(
                    ...
                    child: Image.network(
                      data.product.image!.contains('http')
                          ? data.product.image!
                          : '${Variables.baseImageUrl}/products/${data.product.image}',
                      width: 68.0,
                      height: 68.0,
                      fit: BoxFit.cover,
                    ),
                  ...
                  ClipRRect(
                    ...
                    child: InkWell(
                      onTap: () {
                        context
                            .read<CheckoutBloc>()
                            .add(CheckoutEvent.removeToCart(data.product));
                      },
                  ...
                  ClipRRect(
                    ...
                    child: InkWell(
                      onTap: () {
                        context
                            .read<CheckoutBloc>()
                            .add(CheckoutEvent.addToCart(data.product));
                      },
                      child: const ColoredBox(
                        color: AppColors.primary,
                        child: Padding(
