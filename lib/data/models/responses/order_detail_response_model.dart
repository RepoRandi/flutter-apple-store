  ...
  factory OrderDetail.fromMap(Map<String, dynamic> json) => OrderDetail(
        ...
        orderItems: json["order_items"] == null
            ...
            : List<OrderDetailItem>.from(
                json["order_items"]!.map((x) => OrderDetailItem.fromMap(x))),
...
class OrderDetailItem {
  ...
  factory OrderDetailItem.fromJson(String str) =>
      OrderDetailItem.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OrderDetailItem.fromMap(Map<String, dynamic> json) => OrderDetailItem(
        id: json["id"],
